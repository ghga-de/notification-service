...
>
> Development of the notification service continues in the GHGA mono repository at
> [ghga-de/ghga](https://github.com/ghga-de/ghga), where the service now lives under
> [`services/notification-service`](https://github.com/ghga-de/ghga/tree/main/services/notification-service).
> Please open issues and pull requests there.
>
> This repository is kept read-only for its history. Version 7.0.1 (August 2026) was the
